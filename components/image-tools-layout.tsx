                    ...
                    <div key={file.id} className="relative group">
                      <div className="relative bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => removeFile(file.id)}
                          className="absolute top-2 right-2 h-6 w-6 p-0 bg-white/90 opacity-0 group-hover:opacity-100 transition-opacity"
                        >
                          <X className="h-3 w-3" />
                        </Button>
                        ...
                        {file.processed && (
                          <Button
                            ...
                            className="absolute bottom-2 right-2 h-6 w-6 p-0 bg-white/90 opacity-0 group-hover:opacity-100 transition-opacity"
                          >
