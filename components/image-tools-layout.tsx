                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {files.map((file) => (
                    <div key={file.id} className="relative group">
                      <div className="aspect-square bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                        <img
                        ...
                        <Button
                          variant="destructive"
                          size="sm"
                          className="absolute top-2 left-2 opacity-0 group-hover:opacity-100 transition-opacity w-6 h-6 p-0"
              ...
              <div className="p-6 space-y-6">
                ...
                {files.length > 0 && (
                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                    <h4 className="text-sm font-semibold text-purple-800 mb-2">Files Info</h4>
              ...
              <div className="space-y-2">
                <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                  ...
                  <p className="text-xs text-green-600">
                    {files.filter(f => f.processed).length} image{files.filter(f => f.processed).length !== 1 ? 's' : ''} ready for download
                  </p>
                </div>
                ...
                >
                  ...
                  Download {files.filter(f => f.processed).length > 1 ? 'All (ZIP)' : 'Image'}
                </Button>
              </div>
            )}
          </div>
